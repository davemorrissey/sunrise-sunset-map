...
class DateSelector extends Component {
  ...
  render() {
    ...
    if (this.state.type === 'buttons') {
      buttons = <div>
        <button className="back" onClick={this.dateDiff.bind(this, '-m')}><i className="fa fa-caret-left"/> M</button>
        <button className="back" onClick={this.dateDiff.bind(this, '-w')}><i className="fa fa-caret-left"/> W</button>
        <button className="back" onClick={this.dateDiff.bind(this, '-d')}><i className="fa fa-caret-left"/> D</button>
        <button className="forward" onClick={this.dateDiff.bind(this, '+d')}>D <i className="fa fa-caret-right"/></button>
        <button className="forward" onClick={this.dateDiff.bind(this, '+w')}>W <i className="fa fa-caret-right"/></button>
        <button className="forward" onClick={this.dateDiff.bind(this, '+m')}>M <i className="fa fa-caret-right"/></button>
      </div>
    }
    ...
    let table = <table className="datepicker">
        <thead>
          <tr>
    ...
    if (this.state.type === 'calendar') {
      calendar = <div id="datepicker-wrapper">
        <div id="datepicker">{table}</div>
      </div>
    }
    ...
    return (
      <div id="datenav">
        <div id="date-current">{dateLong}<a id="date-picker-toggle" onClick={this.toggleDatePicker.bind(this)}><i className="fa fa-calendar"/></a></div>
        {buttons}
        {calendar}
      </div>
    );
